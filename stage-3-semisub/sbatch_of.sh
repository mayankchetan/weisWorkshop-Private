#!/bin/bash
#SBATCH --time=2-00:00:00          # walltime limit (max 10 days)
...
conda activate /projects/weis/mchetan/weis-workshop/env/weis-workshop-script1
echo "Number of Tasks: $SLURM_NTASKS"
echo "Number of Tasks per node: $SLURM_NTASKS_PER_NODE"
# mpirun -n $SLURM_NTASKS -ppn $SLURM_NTASKS_PER_NODE python aeroStruct.py
mpirun -n $SLURM_NTASKS --npernode $SLURM_NTASKS_PER_NODE python stage-3-semisub_of_driver.py